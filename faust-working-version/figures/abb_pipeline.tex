...
\begin{figure}[H]
	...
	\caption{Vom Quelltext zum Messwert am Beispiel des Biquad-Filters. Der
		Faust-Compiler erzeugt der .dsp-Datei eine C++-Klasse, die ein Wrapper an dieselbe Schnittstelle anbindet wie die manuelle Implementierung und dann identisch verläuft.}
	\label{fig:pipeline}
\end{figure}
