...
Die vorliegende Arbeit untersucht systematisch, wie sich FAUST-generierter C++-Code gegenüber einer manuell implementierten C++-Referenz bei elementaren DSP-Bausteinen verhält. Betrachtet werden eine Verstärkungsstufe (Gain-Stufe), ein Biquad-Filter, Finite-Impulse-Response-Filter (FIR-Filter) unterschiedlicher Länge sowie FFTs unterschiedlicher Größe. Der Schwerpunkt liegt auf reproduzierbaren Mikrobenchmarks, nicht auf einer vollständigen Audioanwendung.


\section{Forschungsfrage und Zielsetzung}
Ziel dieser Arbeit ist es, die Eignung der domänenspezifischen Sprache FAUST für die Implementierung ausgewählter Echtzeit-DSP-Bausteine zu untersuchen. Dazu werden FAUST-generierter C++-Code und eine manuell implementierte C++-Referenz und reproduzierbaren Vergleiche mit unterschiedlichen Datenabhängigkeiten -und Skalierungseigenschaften erzeugt. Neben der Laufzeit werden Speicherverbrauch und Binärgröße betrachtet.
Ergänzend werden Codelänge und Implementierungskomplexität analysiert.
